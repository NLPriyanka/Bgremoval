...
export const testimonialsData = [
    {
        id: 1,
        text: "This tool is incredibly easy to use and has transformed the way I edit my photos. Highly recommended for anyone looking for quick, professional results!",
    ...
    {
        id: 2,
        text: "Amazing quality and lightning-fast results! It’s my go-to app for all my background removal needs,and it saves me so much time! Absolutely love this tool.",
        author: "Liam Parker",
        image: profile_img_2,
        jobTitle:'UI Deginer'
    },
